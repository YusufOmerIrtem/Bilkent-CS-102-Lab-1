    ...
    public static void main(String[] args) {
        ...
        while(!game.isGameFinished()) {
            ...
            for( int i = 0; i < playerNumber && !game.isGameFinished(); i++ ) {
                ...
                System.out.print("Player " + (i+1) + game.getPlayers()[i].getName() + "'s" + " number of cells: ");
                ...
                game.move(game.getPlayers()[i], direction, numberOfCells);
